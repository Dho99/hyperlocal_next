...
const STATUS_OPTIONS = [
    {
        value: "APPROVED",
        label: "Tervalidasi",
        description: "Penginapan memenuhi persyaratan",
        icon: CheckCircle2,
    ...
    },
    {
        value: "REJECTED",
        label: "Ditolak",
        description: "Penginapan tidak memenuhi persyaratan",
        icon: XCircle,
    ...
    },
    {
        value: "REVISION",
        label: "Perlu Revisi",
        description: "Penginapan perlu melengkapi data",
        icon: RefreshCw,
...
interface PenginapanValidationFormProps {
    accommodationId: string;
    currentStatus: string;
    currentNotes: string | null;
}

export function PenginapanValidationForm({
    accommodationId,
    currentStatus,
    currentNotes,
}: PenginapanValidationFormProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setSubmitting(true);
        try {
            const res = await fetch(`/api/admin/validasi/penginapan/${accommodationId}`, {
                method: "PATCH",
            ...
            if (data.success) {
                ...
                router.push("/validasi/penginapan");
                router.refresh();
            } else {
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
            <div className="border border-stone-200 bg-white p-5">
                ...
                <p className="text-xs text-stone-500 mb-4">
                    Tentukan status validasi penginapan.
                </p>
