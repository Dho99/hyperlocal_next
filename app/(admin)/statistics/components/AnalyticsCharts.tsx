                ...
                <div className="flex-1 flex flex-col sm:flex-row items-center justify-center gap-8 lg:gap-16 py-4">
                    ...
                    <div className="relative w-48 h-48 flex-shrink-0 drop-shadow-sm">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center flex-col">
                            <span className="text-3xl font-extrabold text-gray-900 dark:text-card-foreground tracking-tight">
                                {umkmStatus.verifiedPercent}%
                            </span>
                            <span className="text-sm text-gray-500 dark:text-card-foreground font-semibold mt-1">
                                Verified
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
                        <div className="flex flex-col">
                            ...
                            <div className="text-xs text-gray-400 dark:text-card-foreground font-medium">
