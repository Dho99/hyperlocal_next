    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            ...
            <div className="bg-white dark:bg-card rounded-xl p-6 border border-emerald-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="text-3xl font-bold text-gray-500 dark:text-card-foreground tracking-tight">
            ...
            <div className="bg-white dark:bg-card rounded-xl p-6 border border-emerald-100 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex justify-between items-start mb-4">
                    <div className="w-12 h-12 bg-amber-100 dark:bg-amber-500 rounded-lg flex items-center justify-center">
            ...
            <div className="bg-white dark:bg-card rounded-xl p-6 border border-emerald-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="text-3xl font-bold text-gray-900 dark:text-card-foreground tracking-tight mb-3">
                    {stats.avgHalalScore}
                ...
                <div className="h-2 w-full bg-gray-100 rounded-full overflow-hidden">
                    <div
                        ...
                        style={{ width: `${stats.avgHalalScore}%` }}
                    ></div>
                </div>
            </div>
        </div>
