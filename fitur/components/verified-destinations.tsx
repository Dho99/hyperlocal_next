                ...
                {items.map((destination) => (
                    <motion.div key={destination.id} variants={itemVariants}>
                        <MotionLink
                            ...
                            className="block overflow-hidden rounded-2xl border border-white/80 bg-white/40 backdrop-blur-md shadow-lg shadow-stone-950/5 transition-all duration-300 hover:bg-white/70"
