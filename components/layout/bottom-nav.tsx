...
export function BottomNav() {
    ...
    return (
        <nav className="fixed bottom-0 left-0 z-50 grid w-full grid-cols-5 items-center rounded-t-2xl bg-white/80 py-2 shadow-[0_-4px_12px_rgba(0,0,0,0.06)] backdrop-blur-lg md:hidden">
                    ...
                    >
                        <div
                            className={`flex flex-col items-center justify-center gap-1 px-3 py-1.5 transition active:scale-95 ${
                                active
                                    ? "rounded-xl bg-emerald-100 text-emerald-900"
